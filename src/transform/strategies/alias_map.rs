...
mod tests {
    ...
    fn sc_float_aliases() -> SeriesContext {
        SeriesContext::default()
            .with_identifier(Identifier::Regex("sid".to_string()))
    ...
    fn df_aliasing() -> DataFrame {
        ...
        let col3 = Column::new("sid".into(), [10.1, 20.2, 30.3, 40.4]);
    ...
    fn df_no_aliasing() -> DataFrame {
        ...
        let col3 = Column::new("sid".into(), [10.2, 20.3, 30.4, 40.5]);
    ...
    fn test_aliasing(mut cdf_aliasing: ContextualizedDataFrame) {
        ...
        assert_eq!(
            cdf_aliasing.clone().data().column("sid").unwrap(),
            &Column::new("sid".into(), [20.2, 40.4, 60.6, 80.8])
        );
        assert_eq!(
    ...
    fn test_aliasing_with_nulls(mut cdf_nulls: ContextualizedDataFrame) {
        ...
        assert_eq!(
            cdf_nulls.data().column("sid").unwrap(),
            &Column::new(
                "sid".into(),
                [
                    AnyValue::Float64(20.2),
    ...
    fn test_get_column_alias_map_pairs(
        ...
        let col_float = df.column("sid").unwrap().name().clone();

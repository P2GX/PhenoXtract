...
use phenoxtract::transform::strategies::FenominalStrategy;
use phenoxtract::{
    Pipeline,
...
#[fixture]
fn cohort_sheet_conditions() -> TableContext {
    TableContext::new(
        ...
        vec![
            SeriesContext::default()
                ...
                .with_data_context(Context::SubjectId),
            SeriesContext::default()
                .with_identifier(Identifier::Regex("Condition".to_string()))
...
fn test_feno(
    ...
    cohort_sheet_conditions: TableContext,
) {
    ...
    let mut data_sources = [DataSource::Excel(ExcelDatasource::new(
        usidnet_path,
        vec![cohort_sheet_context, cohort_sheet_conditions],
        vec![
            ExtractionConfig::new("Cohort".to_string(), true, true),
            ExtractionConfig::new("Conditions".to_string(), true, true),
        ],
    ))];

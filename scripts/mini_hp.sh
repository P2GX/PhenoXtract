...
OBO=https://github.com/obophenotype/human-phenotype-ontology/releases/download/v2025-10-22/hp.obo
...
java -jar ./scripts/robot/robot.jar merge ${INPUTS} --output tests/assets/ontologies/hp.toy.json 2>&1 | grep -v "WARNING:"

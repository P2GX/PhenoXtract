...
understand. See here for a list of all current strategies: [Strategies](README_NEW.md#strategies). The user can decide
...
(TODO: Make clearer what this list means)

...
pub struct TransformContext {
    ...
    medicine_bi_dict_lib: Arc<BiDictLibrary>,
...
impl PartialEq for TransformContext {
    fn eq(&self, other: &Self) -> bool {
        self.meta_data == other.meta_data
            ...
            && self.medicine_bi_dict_lib == other.medicine_bi_dict_lib
...
impl TransformContext {
    ...
    pub fn medicine_bi_dict_lib(&self) -> &Arc<BiDictLibrary> {
        &self.medicine_bi_dict_lib
    }
...
pub struct TransformContextBuilder {
    ...
    medicine_bi_dict_lib: BiDictLibrary,
...
impl TransformContextBuilder {
    pub fn new(
        ...
        Self {
            ...
            medicine_bi_dict_lib: BiDictLibrary::empty_with_name("MEDICIN"),
    ...
    pub fn add_medicine_bidict(&mut self, bidict: Box<dyn BiDict>) {
        self.medicine_bi_dict_lib.add_bidict(bidict);
    }
    ...
    pub fn build(self) -> TransformContext {
        TransformContext {
            ...
            medicine_bi_dict_lib: Arc::new(self.medicine_bi_dict_lib),
